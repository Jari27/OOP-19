...
public class InputHelper {
    ...
    /**
     * Displays what number the user needs to enter to select a certain action from the list of valid actions
     *
     * @param validActions the list of valid actions
     */
    ...
    /**
     * Retrieves a valid action as integer from the user (i.e. a number between  and <code>numOptions</code>)
     *
